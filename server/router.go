...
func _fs(g *gin.RouterGroup) {
	...
	g.POST("/upload/policy", handles.FsUploadPolicy)
	g.POST("/upload/init", uploadLimiter, handles.FsChunkInit)
	g.PUT("/upload/chunk", uploadLimiter, handles.FsChunkUpload)
	g.POST("/upload/complete", handles.FsChunkComplete)
	g.POST("/upload/cancel", handles.FsChunkCancel)
